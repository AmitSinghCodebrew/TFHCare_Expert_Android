...
import com.consultantvendor.utils.downloadFile
...
class WebViewActivity : DaggerAppCompatActivity() {
    ...
    private fun initialise() {
        ...
        when {
            ...
            intent.hasExtra(SUPPORT_MODULE) -> {
                loadUrl = intent.getStringExtra(SUPPORT_MODULE) ?: ""
            }
            else -> {
    ...
    private fun setListeners() {
        binding.toolbar.setNavigationOnClickListener { checkBackPressed() }
    ...
    companion object {
        ...
        const val SUPPORT_MODULE = "SUPPORT_MODULE"
